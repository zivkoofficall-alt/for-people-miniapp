      ...
      <div className="fp-sheet-anim" style={styles.sheet} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ ...styles.planCard, ...styles.planCardPro }}>
          ...
          {PLAN_FEATURES.pro.map((f, i) => (
            <div key={i} style={styles.planFeatureRow}><Check size={14} color={styles.planCardPro ? "#fff" : "#22A37A"} style={{ flexShrink: 0, marginTop: 1 }} /><span style={styles.planFeatureText}>{f}</span></div>
          ))}
