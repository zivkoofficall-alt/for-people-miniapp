...
// Реферальная программа (см. api/_lib/referrals.js на бэкенде — значение
// должно совпадать с REFERRAL_BONUS_AI_REQUESTS там, модуль общий не шарится
// между фронтом и serverless-функциями). Это только для отображения
// ("+5 за друга") — реальное начисление считает сервер.
const REFERRAL_BONUS_PER_FRIEND = 5;

export { MESSENGERS, DEFAULT_CATEGORIES, ENERGY_OPTIONS, TRUST_OPTIONS, STEP_DEFS, AI_SUGGESTIONS, TASK_TYPES, TASK_TYPE_COLORS, DEFAULT_TASK_TYPES, TASK_TYPE_PALETTE, STATUS_COLUMNS, PLAN_FEATURES, PRO_PRICE_LABEL, PRO_PRICE_STARS, PRO_PRICE_STARS_OLD, PAYMENT_METHODS, CHANNEL_URL, CHANNEL_BONUS_AMOUNT, REFERRAL_BONUS_PER_FRIEND };
