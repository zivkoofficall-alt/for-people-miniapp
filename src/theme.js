...
const styles = {
  ...
  cardActionsRow: { display: "flex", gap: 6, marginTop: 4 },
  ...
  cardActionPrimary: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 5, height: 30, borderRadius: 10, background: PURPLE, color: "#fff", fontSize: 11.5, fontWeight: 700, textDecoration: "none" },
  ...
  fab: { position: "fixed", bottom: 78, right: 20, width: 56, height: 56, borderRadius: "50%", background: INK, border: "none", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 10px 26px rgba(11,11,16,0.3)", zIndex: 40 },
  fabSecondary: { position: "fixed", bottom: 144, right: 24, width: 46, height: 46, borderRadius: "50%", background: PURPLE, border: "none", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 20px rgba(124,77,255,0.4)", zIndex: 40 },
  bottomBar: {
  ...
  boardAddBtn: { display: "flex", alignItems: "center", gap: 6, background: INK, color: "#fff", border: "none", borderRadius: 999, padding: "9px 14px", fontSize: 12.5, fontWeight: 700 },
  ...
  goalStripTrack: { height: 5, borderRadius: 999, background: "rgba(11,11,16,0.08)", overflow: "hidden", marginTop: 5 },
  goalStripFill: { height: "100%", borderRadius: 999, background: PURPLE },
  goalStripPct: { fontSize: 12, fontWeight: 700, color: PURPLE, flexShrink: 0 },
  ...
  planBadgePro: { display: "inline-flex", alignItems: "center", gap: 5, fontSize: 11, fontWeight: 700, color: "#fff", background: `linear-gradient(135deg, ${PURPLE}, #9B7FF3)`, borderRadius: 999, padding: "5px 12px" },
  ...
  paymentMethodChipActive: { background: PURPLE, color: "#fff", border: `1px solid ${PURPLE}` },
...
export { globalCss, INK, MUTED, PURPLE, PURPLE_SOFT, BG, CARD_BORDER, SHEET_BG, CARD_SHADOW, styles };
