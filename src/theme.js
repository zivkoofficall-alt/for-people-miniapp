...
const styles = {
  ...
  heroPanelLeft: { flex: 1.15, minWidth: 0, display: "flex", flexDirection: "column" },
  ...
  heroStatsRow: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 4 },
  heroStatItem: { minWidth: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: 2 },
  ...
  heroStatLabel: { width: "100%", fontSize: 8.5, lineHeight: 1.2, color: "rgba(255,255,255,0.8)", fontWeight: 600, textAlign: "center", whiteSpace: "normal", wordBreak: "break-word" },
  featuredLabel: { fontSize: 10.5, fontWeight: 700, color: "rgba(255,255,255,0.85)", marginTop: 4 },
  featuredCard: { width: "100%", boxSizing: "border-box", background: "#fff", borderRadius: 16, padding: "10px 12px", display: "flex", flexDirection: "column", gap: 8, boxShadow: "none", border: "none", textAlign: "left" },
  featuredTopRow: { display: "flex", alignItems: "center", gap: 10, width: "100%", minWidth: 0 },
  featuredAvatar: { width: 36, height: 36, borderRadius: 12, background: PURPLE_SOFT, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 14, color: PURPLE, overflow: "hidden", flexShrink: 0 },
  featuredBody: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 1 },
  featuredName: { fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 13, color: INK, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  featuredSub: { fontSize: 10.5, color: MUTED, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  featuredBtn: { width: "100%", boxSizing: "border-box", display: "flex", alignItems: "center", justifyContent: "center", gap: 5, borderRadius: 999, padding: "8px 0", fontSize: 11, fontWeight: 700, color: "#fff", background: PURPLE_GRADIENT, whiteSpace: "nowrap" },
  ...
  fab: { position: "fixed", bottom: 78, right: 20, width: 56, height: 56, borderRadius: "50%", background: PURPLE_GRADIENT, border: "none", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 10px 26px rgba(124,77,255,0.4)", zIndex: 40 },
  fabSecondary: { position: "fixed", bottom: 144, right: 24, width: 46, height: 46, borderRadius: "50%", background: PURPLE_GRADIENT, border: "none", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 20px rgba(124,77,255,0.4)", zIndex: 40 },
  bottomBar: {
