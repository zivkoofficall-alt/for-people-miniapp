...
const styles = {
  ...
  fabSecondary: { position: "fixed", bottom: 88, right: 24, width: 46, height: 46, borderRadius: "50%", background: PURPLE, border: "none", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 20px rgba(124,77,255,0.4)", zIndex: 40 },
  ...
  // --- Цели (Модуль 3D) ---
  goalCard: { background: "#fff", border: CARD_BORDER, borderRadius: 18, padding: 14, boxShadow: CARD_SHADOW, marginBottom: 10 },
  ...
  goalQualToggle: { display: "flex", gap: 8, marginTop: 4 },
  ...
  versionTag: { position: "fixed", bottom: 6, left: 12, fontSize: 9.5, color: "rgba(11,11,16,0.32)", fontWeight: 500, zIndex: 5, pointerEvents: "none" },
};
