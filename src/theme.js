...
const styles = {
  ...
  taskRowWrap: { position: "relative", borderRadius: 16, overflow: "hidden", marginBottom: 8 },
  ...
  taskRow: { position: "relative", background: "#fff", border: CARD_BORDER, borderRadius: 16, padding: "11px 12px", display: "flex", alignItems: "flex-start", gap: 9, boxShadow: CARD_SHADOW, touchAction: "pan-y" },
