...
const styles = {
  ...
  iconBtn: { position: "relative", width: 33, height: 33, borderRadius: 999, background: "#fff", border: CARD_BORDER, display: "flex", alignItems: "center", justifyContent: "center", color: INK, boxShadow: CARD_SHADOW },
  ...
  heroStatItem: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: 2 },
  ...
  featuredCard: { width: "100%", background: "#fff", borderRadius: 16, padding: "10px 12px", display: "flex", alignItems: "center", gap: 10, boxShadow: "none", border: "none", textAlign: "left" },
  featuredAvatar: { width: 42, height: 42, borderRadius: 13, background: PURPLE_SOFT, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 15, color: PURPLE, overflow: "hidden", flexShrink: 0 },
  ...
  featuredBtn: { display: "flex", alignItems: "center", gap: 4, borderRadius: 999, padding: "7px 11px", fontSize: 10.5, fontWeight: 700, color: "#fff", background: PURPLE_GRADIENT, flexShrink: 0, whiteSpace: "nowrap" },
