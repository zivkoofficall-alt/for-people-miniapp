...
const styles = {
  ...
  bulkBar: { position: "fixed", bottom: "calc(20px + env(safe-area-inset-bottom))", left: 16, right: 16, background: INK, borderRadius: 20, padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", zIndex: 45, boxShadow: "0 10px 30px rgba(0,0,0,0.25)" },
