...
const styles = {
  ...
  pillBtnGhostActive: { background: PURPLE_GRADIENT, color: "#fff", border: "1px solid transparent" },
  ...
  featuredCard: { width: "100%", background: "#fff", borderRadius: 16, padding: "8px 10px", display: "flex", alignItems: "center", gap: 8, boxShadow: CARD_SHADOW, textAlign: "left" },
  featuredAvatar: { width: 32, height: 32, borderRadius: 10, background: PURPLE_SOFT, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 12, color: PURPLE, overflow: "hidden", flexShrink: 0 },
  featuredBody: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 1 },
  featuredName: { fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 12, color: INK, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  featuredSub: { fontSize: 9.5, color: MUTED, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  featuredBtn: { display: "flex", alignItems: "center", gap: 4, borderRadius: 999, padding: "6px 10px", fontSize: 10, fontWeight: 700, color: "#fff", background: PURPLE_GRADIENT, flexShrink: 0, whiteSpace: "nowrap" },
  ...
  categoryChipActive: { background: PURPLE_GRADIENT, color: "#fff", border: "1px solid transparent" },
  ...
  stepTabActive: { background: PURPLE_GRADIENT, color: "#fff", border: "1px solid transparent" },
