...
// Модель совпадает с ai-proxy.js (gemini-2.5-flash) для консистентности —
// это стабильный зафиксированный релиз, а не "плывущий" alias вида
// gemini-flash-latest. Опционально переопределяется GEMINI_MODEL.
