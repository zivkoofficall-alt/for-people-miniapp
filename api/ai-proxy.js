...
// JSON.parse ниже падал на части естественных запросов. gemini-2.5-flash —
// стабильный, зафиксированный релиз, предназначенный именно для таких
// быстрых задач с рассуждением (сопоставление контактов по смыслу запроса).
